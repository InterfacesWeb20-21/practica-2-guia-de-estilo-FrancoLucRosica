...
!(function (t) {
        ...
        if (
          ...
          if (
            ...
            (r = this.clickThruHandle(e, r)),
              setTimeout(
                function () {
                  this.eventManager.onlyOnce.Ad_Click_Thru = !1
                }.bind(this),
                500
              )
      ...
      initAppNexus: function (t, e, i, s, a) {
        ...
        var d = { duration: s },
          l = {
            ...
            videoElementsCallback: function () {
              return { videoElement: e, videoContainer: i }
            }
          }
      ...
      initMoatTracking: function (t, e, i, r, s, n) {
        ...
        ;(e = {
          ...
          dispatchEvent: function (t) {
            this.sendEvent
              ? (a && (a.push(t), (t = a), (a = !1)), this.sendEvent(t))
              : a && a.push(t)
          },
          clientCallback: n
        }),
  ...
  function (t, e) {
    ...
    ;(t.exports = a),
      ...
      (t.exports.equals = function (t, e) {
        return t && e && t.code === e.code
      })
  },
  function (t, e, i) {
    var r = i(9),
          ...
          switch (
            ...
            case r.Ad_Click_Thru:
              this.events[a].forEach(function (t) {
                setTimeout(function () {
                  t.callback.call(t.context, e, i, o)
                }, 0)
              })
              break
  ...
  function (t, e, i) {
    ...
    function o(t, e, i) {
      return (e = n(t, e, i)), a(e)
    }
    function a(t) {
      function e() {
        4 === u.readyState && setTimeout(n, 0)
      }
      function i() {
        var t = void 0
        if (((t = u.response ? u.response : u.responseText || d(u)), y))
          try {
            t = JSON.parse(t)
          } catch (e) {}
        return t
            ...
            0 !== e
              ? ((r = {
                ...
                u.getAllResponseHeaders &&
                  (r.headers = h(u.getAllResponseHeaders())))
    ...
    ;(t.exports = o),
      ...
      r(['get', 'put', 'post', 'patch', 'head', 'delete'], function (t) {
        o['delete' === t ? 'del' : t] = function (e, i, r) {
          return (i = n(e, i, r)), (i.method = t.toUpperCase()), a(i)
        }
      })
  },
  function (t, e) {
  ...
  function (t, e, i) {
    ...
    var r = i(20),
      ...
      o = i(38),
      a = i(39),
      d = r.call(Function.call, o())
    s(d, { getPolyfill: o, implementation: n, shim: a }), (t.exports = d)
  },
  function (t, e, i) {
    'use strict'
    var r = i(21)
  ...
  function (t, e) {
    ...
    t.exports = function (t) {
      var e = this
      if ('function' != typeof e || s.call(e) !== n) throw new TypeError(i + e)
      for (
        var o,
          a = r.call(arguments, 1),
          d = function () {
            if (this instanceof o) {
              var i = e.apply(this, a.concat(r.call(arguments)))
              return Object(i) === i ? i : this
            }
            return e.apply(t, a.concat(r.call(arguments)))
          },
          l = Math.max(0, e.length - a.length),
          u = [],
          c = 0;
        c < l;
        c++
    ...
    var r = i(23),
      ...
      h = function (t, e) {
        var i = arguments.length > 2 ? arguments[2] : {},
          n = r(e)
        s && (n = o.call(n, Object.getOwnPropertySymbols(e)))
        for (var a = 0; a < n.length; a += 1) c(t, n[a], e[n[a]], i[n[a]])
      }
  ...
  function (t, e, i) {
    ...
    if (!Object.keys) {
      ...
      r = function (t) {
        ...
        var h = l && i
        if (a && t.length > 0 && !s.call(t, 0))
          for (var p = 0; p < t.length; ++p) c.push(String(p))
        if (r && t.length > 0)
          for (var g = 0; g < t.length; ++g) c.push(String(g))
        else
          for (var m in t)
            (h && 'prototype' === m) || !s.call(t, m) || c.push(String(m))
        if (d)
          for (var v = f(t), _ = 0; _ < u.length; ++_)
            (v && 'constructor' === u[_]) || !s.call(t, u[_]) || c.push(u[_])
        return c
      }
    }
    t.exports = r
  ...
  function (t, e, i) {
    ...
    var r = i(20),
      s = i(27),
      n = r.call(Function.call, String.prototype.replace),
      o = /^[\x09\x0A\x0B\x0C\x0D\x20\xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF]+/,
      a = /[\x09\x0A\x0B\x0C\x0D\x20\xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF]+$/
    t.exports = function () {
      var t = s.ToString(s.CheckObjectCoercible(this))
      return n(n(t, o, ''), a, '')
    }
  },
  function (t, e, i) {
    ...
    var r = i(28),
      ...
      g = {
        ...
        ToInteger: function (t) {
          ...
          return d(e) ? 0 : 0 !== e && l(e) ? u(e) * Math.floor(Math.abs(e)) : e
        },
        ToInt32: function (t) {
        ...
        ToUint16: function (t) {
          var e = this.ToNumber(t)
          if (d(e) || 0 === e || !l(e)) return 0
          var i = u(e) * Math.floor(Math.abs(e))
          return c(i, 65536)
        },
        ToString: function (t) {
          return o(t)
        ...
        ToObject: function (t) {
          return this.CheckObjectCoercible(t), s(t)
        },
        ...
        SameValue: function (t, e) {
          return t === e ? 0 !== t || 1 / t === 1 / e : d(t) && d(e)
        },
        Type: function (t) {
          return null === t
            ? 'Null'
        ...
        IsPropertyDescriptor: function (t) {
          ...
          for (var i in t) if (f(t, i) && !e[i]) return !1
          var r = f(t, '[[Value]]'),
            s = f(t, '[[Get]]') || f(t, '[[Set]]')
          if (r && s)
            throw new n(
  ...
  function (t, e, i) {
    ...
    var r = i(28),
      ...
      a = {
        'Property Descriptor': function (t, e) {
          ...
          for (var r in e) if (o(e, r) && !i[r]) return !1
          var n = o(e, '[[Value]]'),
            a = o(e, '[[Get]]') || o(e, '[[Set]]')
          if (n && a)
            throw new s(
    ...
    t.exports = function (t, e, i, r) {
      var o = a[e]
      if ('function' != typeof o) throw new n('unknown record type: ' + e)
      if (!o(t, r)) throw new s(i + ' must be a ' + e)
      console.log(o(t, r), r)
    }
  },
  function (t, e, i) {
    ...
    var r = i(35),
      ...
      o = function (t, e, i) {
        for (var r = 0, s = t.length; r < s; r++)
          n.call(t, r) && (null == i ? e(t[r], r, t) : e.call(i, t[r], r, t))
      },
      a = function (t, e, i) {
        for (var r = 0, s = t.length; r < s; r++)
          null == i ? e(t.charAt(r), r, t) : e.call(i, t.charAt(r), r, t)
      },
      d = function (t, e, i) {
        for (var r in t)
          n.call(t, r) && (null == i ? e(t[r], r, t) : e.call(i, t[r], r, t))
  ...
  function (t, e) {
    function i() {
      for (var t = {}, e = 0; e < arguments.length; e++) {
        var i = arguments[e]
        for (var s in i) r.call(i, s) && (t[s] = i[s])
      }
      return t
    }
    t.exports = i
          ...
          var b64chars =
            ...
            cb_encode = function (t) {
              var e = [0, 2, 1][t.length % 3],
                ...
                r = [
                  b64chars.charAt(i >>> 18),
                  b64chars.charAt((i >>> 12) & 63),
                  e >= 2 ? '=' : b64chars.charAt((i >>> 6) & 63),
                  e >= 1 ? '=' : b64chars.charAt(63 & i)
                ]
              return r.join('')
            },
            btoa = global.btoa
  ...
  function (t, e, i) {
    ...
    ;(l.prototype = {
      ...
      selectMediaFile: function (t, e, i) {
        ...
        var a = Object.keys(r).sort(function (t, e) {
          return t - e
        })
        if (!(a.length > 0))
    ...
    !(function (s, n) {
      ...
      var o = '0.7.21',
        ...
        C = {
          ...
          major: function (t) {
            return typeof t === h ? t.replace(/[^\d\.]/g, '').split('.')[0] : n
          },
          trim: function (t) {
        ...
        T = {
          rgx: function (t, e) {
            for (var i, r, s, o, a, d, u = 0; u < e.length && !a; ) {
              var h = e[u],
                p = e[u + 1]
              for (i = r = 0; i < h.length && !a; )
                if ((a = h[i++].exec(t)))
                  for (s = 0; s < p.length; s++)
                    (d = a[++r]),
                      (o = p[s]),
                      typeof o === c && o.length > 0
                        ? 2 == o.length
                          ? typeof o[1] == l
          ...
          str: function (t, e) {
            for (var i in e)
              if (typeof e[i] === c && e[i].length > 0) {
                for (var r = 0; r < e[i].length; r++)
                  if (C.has(e[i][r], t)) return i === d ? n : i
              } else if (C.has(e[i], t)) return i === d ? n : i
            return t
          }
        },
        I = {
        ...
        x = function (t, e) {
          if (
            ('object' == typeof t && ((e = t), (t = n)), !(this instanceof x))
          )
          ...
          return (
            (this.getBrowser = function () {
              var t = { name: n, version: n }
              return (
                T.rgx.call(t, i, r.browser), (t.major = C.major(t.version)), t
              )
            }),
            (this.getCPU = function () {
              var t = { architecture: n }
              return T.rgx.call(t, i, r.cpu), t
            }),
            (this.getDevice = function () {
              var t = { vendor: n, model: n, type: n }
              return T.rgx.call(t, i, r.device), t
            }),
            (this.getEngine = function () {
              var t = { name: n, version: n }
              return T.rgx.call(t, i, r.engine), t
            }),
            (this.getOS = function () {
              var t = { name: n, version: n }
              return T.rgx.call(t, i, r.os), t
            }),
      ...
      updateVolume: function (t) {
        ...
        try {
          ...
          ;(i || t) &&
            ...
            setTimeout(
              function () {
                this.wrapper.vpaidEventHandler(r.Ad_Volume_Change, e)
              }.bind(this),
              10
            ))
        } catch (n) {
  ...
  function (t, e, i) {
    ...
    ;(_.prototype = {
      ...
      notifyEvent: function (t, e, i, r) {
        ...
        setTimeout(
          function () {
            this.wrapper.vpaidEventHandler(t, e, i, r)
          }.bind(this),
          0
        )
      },
      ...
      videoUpdateTime: function () {
        ...
        try {
          ...
          setTimeout(
            function () {
              this.wrapper.notifyError(r.Video_Timing_Error())
            }.bind(this),
            0
          )
        }
  ...
  function (t, e) {
    var i = {
      AD_ICON_ZINDEX: 2147483647,
      SKIP_BUTTON_ZINDEX: 2147483647,
      PLAY_BUTTON_ZINDEX: 2147483647
    }
    t.exports = i
  },
  function (t, e, i) {
          ...
          (this.renderIcons = function (e, i, r, a, d, l, u) {
            ...
            if (((d = 0 !== d ? d + t : d), c && !(c.length < 1))) {
              var p,
                ...
                g = function (t) {
                  setTimeout(function () {
                    h.resolveCollision(t),
                      n('start to check a collision of ad icon')
                  }, 500)
                }
